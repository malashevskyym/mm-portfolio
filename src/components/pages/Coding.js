    ...
    return (
        <div className= "projectPage">
            <div className="project-grid"> 
                ...
                <CustomPopup onClose={() => setVisibility(false)} show={visibility} name= "Parsing Library Capstone" link="https://github.com/malashevskyym/cosc410-capstone.git" description = "For my capstone project, we used an agile software development framework and test-driven design to create a command line parsing library." language = "Java" tools="Git, Cucumber, Gradle" learned = "I learned the challenges of creating a product from nothing. Working as a team to develop a product using Scrum allowed me to learn how to remain flexible while also delivering the product to the product owner.">
                </CustomPopup>
                ...
                <CustomPopup onClose={() => setVisibility2(false)} show={visibility2} name= "Music Database Selector" link="https://github.com/malashevskyym/project4.git" description = "Created a website that retrieved album data and comments for a user elected band from a database." language= "JavaScript" tools="Express, MongoDB, Mongoose" learned="I learned how the back-end and front-end of a website interact to update the website based on user inputs">
                </CustomPopup>
            </div>
        </div>
    )
