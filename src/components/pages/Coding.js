    ...
    return (
        <div className= "projectPage">
            <div className="project-grid"> 
                ...
                <CustomPopup onClose={() => setVisibility(false)} show={visibility}>
                ...
                <CustomPopup onClose={() => setVisibility1(false)} show={visibility1}>
                ...
                <CustomPopup onClose={() => setVisibility2(false)} show={visibility2}>
