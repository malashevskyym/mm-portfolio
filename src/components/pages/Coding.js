    ...
    return (
        <div className= "projectPage">
            <div className="project-grid"> 
                ...
                <CustomPopup onClose={() => setVisibility1(false)} show={visibility1} children={<MorePInfo name= "Portfolio" link="https://github.com/malashevskyym/mm-portfolio.git" description = "Used the React library to create a website demonstrating my projects and background." language = "JavaScript" tools="React" learned = "I learned the fundamentals of the React Library and creating reusable component-based design." ></MorePInfo>}>
